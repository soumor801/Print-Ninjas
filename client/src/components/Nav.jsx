...
const Nav = (props) => {
  ...
  const unauthenticatedOptions = (
    <>
      <Link className="nav-links" to="/sign-up">
        <div className="nav-links">SIGN UP</div>
      </Link>
      <Link className="nav-links" to="/sign-in">
        <div className="nav-links">SIGN IN</div>
      </Link>
    </>
  );
  // HBGR MENU OPTIONS
  ...
  const authenticatedOptionsMenu = (
    <>
      <Link className="burger-item" className="link" to="/sign-out">
        SIGN OUT
      </Link>
    </>
  );
  ...
  const unauthenticatedOptionsMenu = (
    <>
      <Link className="burger-item" className="link" to="/sign-up">
        SIGN UP
      </Link>
  ...
  const alwaysOptionsMenu = (
    <>
      <Link className="burger-item" className="link" to="/prints">
        PRINTS
      </Link>
      <Link className="burger-item" className="link" to="/about-us">
        ABOUT
      </Link>
    </>
  );
      ...
      <nav>
        <div className="nav-wrapper">
          <Link to="/" classname="nav-logo">
            <img className="nav-logo" src="https://i.imgur.com/oQZa4K9.png" />
          </Link>
          <div className="nav-links">
            <Link to="/prints">
              <div className="nav-links">PRINTS</div>
            </Link>
            <Link to="/about-us">
